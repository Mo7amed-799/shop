    ...
    if (isset($_POST['signup'])) {
        ...
        if ($USERNAME != '' && $PASSWORD != '') {
            ...
            if ($stmt->execute()) {
                ...
                echo "<script>alert('حدث خطأ أثناء إدخال البيانات في قاعدة البيانات'); window.location.href = 'index.html';</script>";
            }
        }
    }
        ...
        if ($USERNAME == 'admin' && $PASSWORD == '0000') {
            ...
            if ($result->num_rows > 0) {
                ...
                if (password_verify($PASSWORD, $row['password'])) {
                    ...
                    echo "<script>alert('كلمة المرور خاطئة'); window.location.href = 'index.html';</script>";
                }
            } else {
                echo "<script>alert('اسم المستخدم غير موجود'); window.location.href = 'index.html';</script>";
            }
        }
    }
}
